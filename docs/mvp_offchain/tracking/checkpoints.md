...
- 2026-03-14: `W2-01` marked `DONE`. Repository aligned to founder-approved `specs/story_template_v1.md` v2 (fixed 7-section order, attribution v2 exact label placement, publishable/not_publishable criteria, full example), and policy lock confirms key points generation with `gpt-4o-mini`.
